...
export function LegalDocView({ doc }: { doc: LegalDoc }) {
  return (
    <main id="main" className="mx-auto w-full max-w-lg px-4 pb-16 pt-8">
      ...
      <p className="mt-3 rounded-xl border border-amber/50 bg-amber/10 p-3 text-xs">
        DRAFT — prepared for attorney review. This text has not yet been reviewed by a lawyer.
      </p>
